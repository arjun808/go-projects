...
for Countint > i {
   Nodestringfinal := fmt.Sprintf("%s-%d", Nodestring, i+1)
   output := CreateInstance(Nodestringfinal, Imagestring, Countint)
   i++
   fmt.Fprintf(w, output)
              }
}

func CreateInstance(Nodename string, Image string, Inscount int64) (string) {
